  ...
  return (
    <section ref={ref} id="contact" className="relative py-32 px-6 max-w-[1200px] mx-auto min-h-screen flex flex-col justify-center overflow-hidden">
      ...
      <div className="grid md:grid-cols-2 gap-16 border-t border-white/10 pt-16">
        ...
        >
          <a href="mailto:ardan.pratama@email.com" className="group flex items-center justify-between border-b border-white/10 pb-4" data-cursor-hover>
            <span className="flex items-center gap-3 font-mono text-xs text-[#888888] uppercase tracking-widest">
              <Mail className="w-4 h-4" /> Email
            </span>
            <span className="font-display text-xl sm:text-2xl group-hover:text-[#FF3300] transition-colors">ardan.pratama@email.com</span>
          </a>
          <a href="https://linkedin.com" className="group flex items-center justify-between border-b border-white/10 pb-4" data-cursor-hover>
            <span className="flex items-center gap-3 font-mono text-xs text-[#888888] uppercase tracking-widest">
              <Briefcase className="w-4 h-4" /> LinkedIn
            </span>
            <span className="font-display text-xl sm:text-2xl group-hover:text-[#FF3300] transition-colors">in/ardanpratama</span>
          </a>
          <a href="https://github.com" className="group flex items-center justify-between border-b border-white/10 pb-4" data-cursor-hover>
            <span className="flex items-center gap-3 font-mono text-xs text-[#888888] uppercase tracking-widest">
              <Terminal className="w-4 h-4" /> GitHub
            </span>
            <span className="font-display text-xl sm:text-2xl group-hover:text-[#FF3300] transition-colors">@ardanpratama</span>
          </a>
          <div className="flex items-center justify-between pt-4">
            <span className="flex items-center gap-3 font-mono text-xs text-[#888888] uppercase tracking-widest">
              <MapPin className="w-4 h-4" /> Location
            </span>
            <span className="font-display text-xl sm:text-2xl text-white">Jakarta, ID</span>
          </div>
        </motion.div>
        </div>
      </motion.div>
